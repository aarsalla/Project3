...
function buildPlot(stock) {
    var apiKey = "REHgZFPuj_3cxTxuwvsn";
      ...
      d3.json(url).then(function(data2) {
        ...
        var name = data2.dataset.name;
        var stock = data2.dataset.dataset_code;
        var startDate = data2.dataset.start_date;
        var endDate = data2.dataset.end_date;
        var dates = unpack(data2.dataset.data, 0);
        var closingPrices = unpack(data2.dataset.data, 1);
